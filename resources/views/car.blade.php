...
@section('content')
<div class="px-6 md:px-16 py-12 mt-16">
    <!-- Booking Details -->
    ...
    <div class="flex justify-between items-center mb-8">
        ...
        <div>
            ...
            <select id="categoryFilter" class="border border-[#706C61] pr-8 pl-3 py-2 rounded-md shadow-sm" onchange="filterCars(this.value)">
                ...
                <!-- loops each car categories then creates an option -->
    ...
    <div class="car-listings">
        <!-- loops each car caterogries and displays a list of cars under that category-->
        @foreach($groupedCars as $category => $categoryCars)
